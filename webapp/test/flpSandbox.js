		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Training",
									"targetURL": "#codedemotraining-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"codedemotraining-display": {
								"semanticObject": "codedemotraining",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=code.demo.training",
									"url": sap.ui.require.toUrl("code/demo/training")
								}
							}
						}
					}
